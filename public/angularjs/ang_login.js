...
angular.module('ebay')
.controller('loginCntrl', ['$rootScope', '$scope', '$http', '$state',
		function($rootScope,$scope, $http, $state) {
			...
			var redirectToHomePage = function() {
				...
				console
						.log("In angular: redirectToHomePage() ");
				$http({
					method : "GET",
					url : '/homepage',
				}).success(function(data) {
									...
									console
											.log("In angular : redirectToHomePage() : Redirected to homepage with error");
									console
											.log("In angular : redirectToHomePage() Error: "
													+ error);
